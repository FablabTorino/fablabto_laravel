...
@section('title', 'Fablab Torino | Regala la tessera')

@section('content')

    <!-- Title section for pricing page -->
    <div id="giftcard" class="content bg-black-darker has-bg extraPageTitle" data-scrollview="true">
        <!-- begin content-bg -->
    ...
    <div id="giftcard" class="content extraPageContentLight" data-scrollview="true">
        <!-- begin container -->
        <div class="container">
            <div class="quote">
                Vuoi regalare la tessera del Fablab? Stupendo!</div>
