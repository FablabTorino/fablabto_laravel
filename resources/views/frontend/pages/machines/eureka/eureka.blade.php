...
@section('title', 'Fablab Torino | Eureka')

@section('content')

    <!-- Title section for history page -->
    <div id="eureka" class="content bg-black-darker has-bg extraPageTitle titleSmall" data-scrollview="true">
        <!-- begin content-bg -->
    ...
    <div id="eureka" class="content extraPageContentGhost" data-scrollview="true">
        <!-- begin container -->
        <div class="container">
            ...
            <div class="product">
                ...
                <div class="product-detail">
                    ...
                    <div class="product-info">
                        ...
                        <ul class="product-info-list">
                            <li><i class="fa fa-circle"></i> Area di taglio: 61 x 46 cm</li>
                            <li><i class="fa fa-circle"></i> Altezza materiale lavorabile: 240mm</li>
                            <li><i class="fa fa-circle"></i> Spessore di taglio:  0-10mm</li>
                            <li><i class="fa fa-circle"></i> Raffreddamento: ad aria</li>
                            <li><i class="fa fa-circle"></i> Potenza laser: 30 watt CO2</li>
                            <li><i class="fa fa-circle"></i> Controller: Proprietario SEI</li>
                        </ul>
                        <!-- END CARATTERISTICHE -->
                    ...
                    <div class="product-image">
                        ...
                        <div class="product-thumbnail">
                            <ul class="product-thumbnail-list">
                                <li class="active"><a href="#" data-click="show-main-image" data-url="/images/machines/eureka/eureka.png"><img src="/images/machines/eureka/eureka.png" alt=""></a></li>
                                <li><a href="#" data-click="show-main-image" data-url="/images/machines/eureka/e1.jpg"><img src="/images/machines/eureka/e1.jpg" alt=""></a></li>
                                <li><a href="#" data-click="show-main-image" data-url="/images/machines/eureka/e2.jpg"><img src="/images/machines/eureka/e2.jpg" alt=""></a></li>
                                <li><a href="#" data-click="show-main-image" data-url="/images/machines/eureka/e3.jpg"><img src="/images/machines/eureka/e3.jpg" alt=""></a></li>
                                <li><a href="#" data-click="show-main-image" data-url="/images/machines/eureka/e4.jpg"><img src="/images/machines/eureka/e4.jpg" alt=""></a></li>
                            </ul>
                        </div>
                ...
                <div class="product-tab">
                    ...
                    <div id="product-tab-content" class="tab-content">
                        ...
                        @include('frontend.pages.machines.eureka._tab-settings')

                        @include('frontend.pages.machines.eureka._tab-faq')
