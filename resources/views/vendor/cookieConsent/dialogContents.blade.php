<div class="cookie-box js-cookie-consent cookie-consent">
    <div class="cookie-box__inner" style="max-width: 1140px; margin: 0 auto">
    ...
    <div class="modal-dialog fullpage">
        <div class="modal-content">
            ...
            <div class="modal-body">
                @include('frontend.pages._cookie_policy')
            </div>
        </div>
    </div>
</div>
